...
public class TipoMaquinaService {
    ...
    public TipoMaquina actualizar(Long id, TipoMaquina tipoMaquina) {
        ...
        TipoMaquina existente = tipoMaquinaRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Tipo de máquina no encontrado"));
    ...
    public void eliminar(Long id) {
        if (!tipoMaquinaRepository.existsById(id)) {
            throw new ResourceNotFoundException("Tipo de máquina no encontrado con id: " + id);
        }
